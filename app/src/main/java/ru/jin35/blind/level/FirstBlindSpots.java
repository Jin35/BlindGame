...
public class FirstBlindSpots extends Level {

    private static final Map MAP = new Map(new int[][]{
            new int[]{W, W, W, W, W, W, W},
            new int[]{W, S | L, 0, 0, 0, L, W},
            new int[]{W, W, W, W, W, 0, W},
            new int[]{W, 0, 0, 0, W, 0, W},
            new int[]{W, 0, 0, 0, W, 0, W},
            new int[]{W, 0, 0, 0, W, F | L, W},
            new int[]{W, W, W, W, W, W, W},
    });

    public FirstBlindSpots(int id, @Nullable Integer nextId) {
        super(id, nextId, MAP);
    }
}
